...
func unregister_draggable(draggable):
	if draggable is DraggableComponent and draggables.has(draggable):
		...
		draggable.mouse_hover_component.mouse_on.disconnect(_on_draggable_mouse_on.bind(draggable))
		draggable.mouse_hover_component.mouse_off.disconnect(_on_draggable_mouse_off.bind(draggable))
